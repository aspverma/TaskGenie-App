...
const ProductData = [
    {
        key: '1',
        image: require('../Assests/DELLi5.png'),
        title: 'Dell I5',
        Price: '$1,199',
    ...
    {
        key: '2',
        image: require('../Assests/dellgaming.png'),
        title: 'Dell I7',
        Price: '$899',
        cartimg: require('../Assests/plus.png'),
        ratingimg: require('../Assests/rating.png'),
    ...
    {
        key: '4',
        image: require('../Assests/lenovo.png'),
        title: 'lenovo 256 RAM',
        Price: '$1,900',
        cartimg: require('../Assests/plus.png'),
        ratingimg: require('../Assests/rating.png'),
        liked: true
    ...
    {
        key: '6',
        image: require('../Assests/acer.png'),
        title: 'Acer Gaming',
        Price: '$300',
        cartimg: require('../Assests/plus.png'),
        ratingimg: require('../Assests/rating.png'),
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headview}>
                ...
                <Text style={styles.Carttext}>Laptop </Text>
            </View>
                <View>
                    <TextInput
                        style={styles.input}
